...
;
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://mdieivjdfgzpfxqvjids.supabase.co") || process.env.VITE_SUPABASE_URL;
const supabaseKey = ("TURBOPACK compile-time value", "sb_publishable_T1RsKDGnTF7G1VIbrsmoOA_fe6_rgdQ") || process.env.VITE_SUPABASE_ANON_KEY;
