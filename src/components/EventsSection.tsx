...
import { CalendarDays, MapPin, Clock, ArrowRight, Dog, PenTool, X, Check, Loader2, Star, Music } from 'lucide-react';
        ...
        {loading ? (
          <div className="flex justify-center py-20">
           ...
           <div className="text-center py-20">
             <p className="font-body text-[#434841] text-lg">No hay eventos programados en este momento. ¡Vuelve pronto para ver más!</p>
           </div>
        ) : (
          <div className="grid md:grid-cols-2 gap-12">
            {events.map((event, idx) => (
              <motion.div 
                ...
                className="group bg-white rounded-[2rem] overflow-hidden shadow-sm border border-[#173018]/10 hover:shadow-xl transition-all duration-500 flex flex-col"
              >
                {/* Event Image Banner */}
                {event.image && (
                  <div className="h-64 relative overflow-hidden shrink-0">
                    ...
                    <div className="absolute top-6 left-6 z-20 bg-white/90 backdrop-blur-sm text-[#173018] px-4 py-2 rounded-full font-headline font-bold text-xs uppercase tracking-widest flex items-center gap-2">
                      {getIcon(event.icon)} {event.collaborator && <span>Con {event.collaborator}</span>}
                    </div>
                  </div>
                )}
                ...
                <div className="p-8 md:p-10 flex flex-col flex-grow">
                  ...
                  <div className="space-y-4 mb-8 text-sm font-body text-[#1a1c1c]/80 flex-grow">
                  ...
                  <button 
                    ...
                    className="w-full text-center bg-[#173018] text-white py-4 rounded-xl font-bold uppercase text-xs tracking-widest hover:bg-[#705d00] transition-colors flex items-center justify-center gap-2 mt-auto shrink-0"
                  >
